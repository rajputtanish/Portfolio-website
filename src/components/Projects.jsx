...
import emsImage from "../assets/ems.avif";
  ...
  const projects = [
    {
      ...
      projectPhoto: calculatorImage,
      link: "https://github.com/rajputtanish/Calculator.git",
    },
    {
      id: 2,
      ...
      imgGradient: "from-voilet-600 to-cyan-400",
      projectPhoto: emsImage,
      link: "https://github.com/rajputtanish/Employee-Management-Software.git",
    },
    {
      id: 3,
      ...
      link: "https://github.com/rajputtanish/Portfolio-website.git",
    },
  ];
    ...
    >
      <div className="container mx-auto px-6 md:px-12">
        <div className="text-center mb-16 space-y-4">
          <h2 className="text-3xl md:text-5xl font-bold bg-clip-text text-transparent bg-gradient-to-r from-cyan-400 via-violet-400 to-violet-600">
            Featured Work
          </h2>
          <p className="text-slate-400 max-w-2xl mx-auto">A selection of my best work demonstrating modern frontend architecture and premium UI/UX design. Some things I've built recently</p>
        </div>
            ...
            <button
              ...
              className={`px-4 py-2 rounded-md text-sm font-medium transition-all ${
                filter === cat
                  ...
                  : "text-slate-400 hover:text-white hover:bg-slate-700 hover:text-white"
              }`}
            >
              {cat}
            </button>
              ...
              <div className="p-6 flex flex-col flex-grow">
                <div className="flex justify-between items-start mb-4">
                  ...
                  <div className="flex gap-3 text-slate-400">
                    <a
                      href={project.link} // Updated to use the project's unique link
